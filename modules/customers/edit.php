...
if (is_post()) {
    $update = $pdo->prepare("UPDATE customers SET name = :name, phone = :phone, email = :email, address = :address, outstanding_balance = :outstanding_balance WHERE id = :id");
    $update->execute([
        ':name' => $_POST['name'],
        ':phone' => $_POST['phone'],
        ':email' => $_POST['email'],
...
$pageTitle = page_title('Edit Customer');
