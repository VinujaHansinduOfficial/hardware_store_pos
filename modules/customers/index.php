...
<div class="card">
    <div class="card-body table-responsive">
        <table class="table table-bordered table-striped">
            <thead><tr><th>ID</th><th>name</th><th>phone</th><th>email</th><th>address</th><th>outstanding_balance</th><th>Status</th><th>Actions</th></tr></thead>
            <tbody>
                <?php foreach ($rows as $row): ?>
                <tr>
                    <td><?= (int)$row['id'] ?></td>
                    <td><?= e($row['name'] ?? '') ?></td><td><?= e($row['phone'] ?? '') ?></td><td><?= e($row['email'] ?? '') ?></td><td><?= e($row['address'] ?? '') ?></td><td><?= e($row['outstanding_balance'] ?? '') ?></td>
