...
$pageTitle = page_title('Customers Outstanding');
$rows = $pdo->query("SELECT id, name, outstanding_balance FROM customers WHERE is_active = 1 ORDER BY outstanding_balance DESC")->fetchAll();
